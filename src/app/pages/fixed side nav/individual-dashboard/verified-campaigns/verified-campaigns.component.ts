...
@Component({
  selector: 'app-verified-campaigns',
  templateUrl: './verified-campaigns.component.html',
  styleUrls: ['./verified-campaigns.component.css']
})
export class VerifiedCampaignsComponent implements OnInit {
  @ViewChild('paginator') paginator!: MatPaginator;
  MyCampagin = ['serialNo', 'campaignerId', 'campaignerName', 'Startdate /lastdate', 'Recived Amount', 'Required Amount', 'Remaining Amount', 'Withdrwal Amount', 'Final View',]
  ...
  ngOnInit(): void {
    ...
    this.service.getVerifiedCampaigns(this.campaignerIdno).subscribe((response: any) => {
